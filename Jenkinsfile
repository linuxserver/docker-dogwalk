pipeline {
  ...
  environment {
    ...
    BUILD_VERSION_ARG = 'DOGWALK_VERSION'
    LS_USER = 'linuxserver'
    LS_REPO = 'docker-dogwalk'
    CONTAINER_NAME = 'dogwalk'
    DOCKERHUB_IMAGE = 'linuxserver/dogwalk'
    DEV_DOCKERHUB_IMAGE = 'lsiodev/dogwalk'
    PR_DOCKERHUB_IMAGE = 'lspipepr/dogwalk'
    DIST_IMAGE = 'ubuntu'
    MULTIARCH = 'false'
    CI = 'true'
    CI_WEB = 'true'
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker buildx build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/linuxserver/docker-dogwalk/packages\" \
          --label \"org.opencontainers.image.documentation=https://docs.linuxserver.io/images/docker-dogwalk\" \
          --label \"org.opencontainers.image.source=https://github.com/linuxserver/docker-dogwalk\" \
          --label \"org.opencontainers.image.version=${EXT_RELEASE_CLEAN}-ls${LS_TAG_NUMBER}\" \
          --label \"org.opencontainers.image.revision=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.vendor=linuxserver.io\" \
          --label \"org.opencontainers.image.licenses=GPL-3.0-only\" \
          --label \"org.opencontainers.image.ref.name=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.title=Dogwalk\" \
          --label \"org.opencontainers.image.description=[DOGWALK](https://studio.blender.org/projects/dogwalk/) is Blender Studio's long awaited second game project, focused on creating a bite-sized interactive storytelling playground. Play as a big adorable dog and explore the winter woods with a little kid.\" \
